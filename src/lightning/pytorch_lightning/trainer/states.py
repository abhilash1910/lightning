...
from lightning.pytorch_lightning.utilities import LightningEnum
...
class TrainerStatus(LightningEnum):
    """Enum for the status of the :class:`~lightning.pytorch_lightning.trainer.trainer.Trainer`"""
...
class TrainerFn(LightningEnum, metaclass=_DeprecationManagingEnumMeta):
    """
    Enum for the user-facing functions of the :class:`~lightning.pytorch_lightning.trainer.trainer.Trainer`
    such as :meth:`~lightning.pytorch_lightning.trainer.trainer.Trainer.fit` and
...
@dataclass
class TrainerState:
    """Dataclass to encapsulate the current :class:`~lightning.pytorch_lightning.trainer.trainer.Trainer` state."""
