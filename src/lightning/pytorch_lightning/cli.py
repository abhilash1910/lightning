...
from lightning.lightning_fabric.utilities.types import _TORCH_LRSCHEDULER
from lightning.pytorch_lightning import Callback, LightningDataModule, LightningModule, seed_everything, Trainer
...
class LightningCLI:
    ...
    def __init__(
        ...
        **kwargs: Any,  # Remove with deprecations of v1.10
        ...
        Args:
            model_class: An optional :class:`~lightning.pytorch_lightning.core.module.LightningModule` class to train on or a
                callable which returns a :class:`~lightning.pytorch_lightning.core.module.LightningModule` instance when
                called. If ``None``, you can pass a registered model with ``--model=MyModel``.
            datamodule_class: An optional :class:`~lightning.pytorch_lightning.core.datamodule.LightningDataModule` class or a
                callable which returns a :class:`~lightning.pytorch_lightning.core.datamodule.LightningDataModule` instance when
            ...
            trainer_class: An optional subclass of the :class:`~lightning.pytorch_lightning.trainer.trainer.Trainer` class or a
                callable which returns a :class:`~lightning.pytorch_lightning.trainer.trainer.Trainer` instance when called.
            ...
            seed_everything_default: Number for the :func:`~lightning.lightning_fabric.utilities.seed.seed_everything`
            ...
            run: Whether subcommands should be added to run a :class:`~lightning.pytorch_lightning.trainer.trainer.Trainer`
    ...
    def init_parser(self, **kwargs: Any) -> LightningArgumentParser:
        ...
        kwargs.setdefault("dump_header", [f"lightning.pytorch_lightning=={pl.__version__}"])
    ...
    def configure_optimizers(
        ...
        """Override to customize the :meth:`~lightning.pytorch_lightning.core.module.LightningModule.configure_optimizers`
        method.
    ...
    def _add_configure_optimizers_method_to_model(self, subcommand: Optional[str]) -> None:
        """Overrides the model's :meth:`~lightning.pytorch_lightning.core.module.LightningModule.configure_optimizers` method
