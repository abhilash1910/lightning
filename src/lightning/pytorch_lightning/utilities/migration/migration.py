...
see :func:`~lightning.pytorch_lightning.utilities.migration.utils.migrate_checkpoint`.
...
3. You can test the migration on a checkpoint (backup your files first) by running:
   ...
   python -m lightning.pytorch_lightning.utilities.upgrade_checkpoint --file model.ckpt
"""
import re
