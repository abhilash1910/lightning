...
from lightning.pytorch_lightning.tuner.lr_finder import _LRFinder, lr_find
from lightning.pytorch_lightning.utilities.exceptions import _TunerExitException
...
class LearningRateFinder(Callback):
    ...
    Example::
        ...
        from lightning.pytorch_lightning.callbacks import LearningRateFinder
