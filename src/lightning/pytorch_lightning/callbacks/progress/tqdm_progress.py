...
from lightning.pytorch_lightning.callbacks.progress.base import ProgressBarBase
...
class TQDMProgressBar(ProgressBarBase):
    ...
    :mod:`tqdm` package and shows up to four different bars:
        ...
        - **main progress:** shows training + validation progress combined. It also accounts for
          ...
          :paramref:`~lightning.pytorch_lightning.trainer.trainer.Trainer.val_check_interval` is used.
    ...
    :class:`~lightning.pytorch_lightning.trainer.trainer.Trainer`.
    ...
    Args:
        ...
        process_position: Set this to a value greater than ``0`` to offset the progress bars by this many lines.
            ...
            :paramref:`~lightning.pytorch_lightning.trainer.trainer.Trainer.process_position` in the
            :class:`~lightning.pytorch_lightning.trainer.trainer.Trainer`.
    """
