...
from lightning.pytorch_lightning.utilities.logger import _version
from lightning.pytorch_lightning.utilities.rank_zero import rank_zero_warn


class ProgressBarBase(Callback):
    r"""
    The base class for progress bars in Lightning. It is a :class:`~lightning.pytorch_lightning.callbacks.Callback`
    that keeps track of the batch progress in the :class:`~lightning.pytorch_lightning.trainer.trainer.Trainer`.
    ...
    def enable(self) -> None:
        ...
        The :class:`~lightning.pytorch_lightning.trainer.trainer.Trainer` will call this in e.g. pre-training
