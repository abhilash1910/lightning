...
class Callback:
    ...
    def on_save_checkpoint(
        ...
        Args:
            trainer: the current :class:`~lightning.pytorch_lightning.trainer.Trainer` instance.
            pl_module: the current :class:`~lightning.pytorch_lightning.core.module.LightningModule` instance.
