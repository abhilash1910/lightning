...
from lightning.pytorch_lightning.overrides.torch_distributed import broadcast_object_list
...
from lightning.pytorch_lightning.utilities.imports import _HPU_AVAILABLE, _TORCH_LESSER_EQUAL_1_10_2
