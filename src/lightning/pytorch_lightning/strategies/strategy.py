...
from lightning.lightning_fabric.plugins import CheckpointIO
from lightning.lightning_fabric.strategies.launchers.base import _Launcher
from lightning.lightning_fabric.utilities import move_data_to_device
from lightning.lightning_fabric.utilities.distributed import ReduceOp
from lightning.lightning_fabric.utilities.optimizer import _optimizer_to_device, _optimizers_to_device
from lightning.lightning_fabric.utilities.types import _PATH
from lightning.pytorch_lightning.core.optimizer import _init_optimizers_and_lr_schedulers, LightningOptimizer
from lightning.pytorch_lightning.plugins import TorchCheckpointIO
...
class Strategy(ABC):
    ...
    def training_step(self, *args: Any, **kwargs: Any) -> STEP_OUTPUT:
        ...
        See :meth:`~lightning.pytorch_lightning.core.module.LightningModule.training_step` for more details
        """
    ...
    def validation_step(self, *args: Any, **kwargs: Any) -> Optional[STEP_OUTPUT]:
        ...
        See :meth:`~lightning.pytorch_lightning.core.module.LightningModule.validation_step` for more details
        """
    ...
    def test_step(self, *args: Any, **kwargs: Any) -> Optional[STEP_OUTPUT]:
        ...
        See :meth:`~lightning.pytorch_lightning.core.module.LightningModule.test_step` for more details
        """
    ...
    def predict_step(self, *args: Any, **kwargs: Any) -> STEP_OUTPUT:
        ...
        See :meth:`~lightning.pytorch_lightning.core.module.LightningModule.predict_step` for more details
        """
