...
from lightning.lightning_fabric.strategies import _StrategyRegistry
from lightning.lightning_fabric.utilities.enums import PrecisionType
from lightning.lightning_fabric.utilities.registry import _is_register_method_overridden
