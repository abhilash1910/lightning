...
from lightning.pytorch_lightning.utilities.rank_zero import WarningCache
...
class PredictionEpochLoop(Loop):
    ...
    def _get_batch_indices(self, dataloader_idx: int) -> List[List[int]]:
        ...
        :class:`~lightning.pytorch_lightning.overrides.distributed.IndexBatchSamplerWrapper`."""
