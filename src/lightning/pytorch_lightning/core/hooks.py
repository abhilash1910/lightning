...
from lightning.pytorch_lightning.utilities import move_data_to_device
...
class ModelHooks:
    ...
    def on_before_optimizer_step(self, optimizer: Optimizer, optimizer_idx: int) -> None:
        ...
        See: :paramref:`~lightning.pytorch_lightning.trainer.Trainer.accumulate_grad_batches`.
...
class DataHooks:
    ...
    def train_dataloader(self) -> TRAIN_DATALOADERS:
        ...
        :paramref:`~lightning.pytorch_lightning.trainer.Trainer.reload_dataloaders_every_n_epochs` to
        a positive integer.
