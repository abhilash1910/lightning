...
from lightning.lightning_fabric.accelerators.mps import MPSAccelerator as _MPSAccelerator
from lightning.lightning_fabric.utilities.device_parser import _parse_gpu_ids
