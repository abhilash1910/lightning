...
_PACKAGE_ROOT = os.path.join(_SOURCE_ROOT, "lightning.lightning_fabric")
...
def _setup_args() -> Dict[str, Any]:
    ...
    return dict(
        ...
        packages=find_packages(where="src", include=["lightning.lightning_fabric", "lightning.lightning_fabric.*"]),
        package_dir={"": "src"},
