...
from lightning.lightning_fabric.plugins import Precision  # avoid circular imports: # isort: split
from lightning.lightning_fabric.accelerators.accelerator import Accelerator
from lightning.lightning_fabric.connector import _Connector, _PLUGIN_INPUT, _PRECISION_INPUT
...
from lightning.lightning_fabric.strategies.strategy import _Sharded, TBroadcast
...
from lightning.lightning_fabric.utilities.data import (
...
from lightning.lightning_fabric.utilities.rank_zero import rank_zero_warn
from lightning.lightning_fabric.utilities.seed import seed_everything
from lightning.lightning_fabric.utilities.warnings import PossibleUserWarning
from lightning.lightning_fabric.wrappers import _FabricDataLoader, _FabricModule, _FabricOptimizer
...
class Fabric:
    ...
    def seed_everything(seed: Optional[int] = None, workers: Optional[bool] = None) -> int:
        ...
        See :func:`lightning.pytorch_lightning.seed_everything` for more details.
        """
        if workers is None:
