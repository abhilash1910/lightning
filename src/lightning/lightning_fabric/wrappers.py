...
from lightning.lightning_fabric.plugins import Precision
from lightning.lightning_fabric.plugins.precision.utils import _convert_fp_tensor
from lightning.lightning_fabric.strategies import Strategy
    ...
    def __init__(
        ...
        Args:
            ...
            original_module: The original, unmodified module as passed into the
                :meth:`lightning.lightning_fabric.fabric.Fabric.setup` method. This is needed when attribute lookup
