...
from lightning.fabric.utilities import _StrategyType
from lightning.fabric.utilities.device_parser import _determine_root_gpu_device, _determine_root_xpu_device
...
from lightning.pytorch.tuner.auto_xpu_select import pick_multiple_xpus
