...
from lightning.lightning_app.frontend.utils import _get_frontend_environment
...
from lightning.lightning_app.utilities.imports import requires
...
class PanelFrontend(Frontend):
    ...
    **app_basic.py**
    ...
    .. code-block:: python
        ...
        from lightning.lightning_app.frontend.panel import PanelFrontend
