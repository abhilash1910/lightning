...
_PACKAGE_ROOT = os.path.join(_SOURCE_ROOT, "lightning.lightning_app")
...
def _setup_args() -> Dict[str, Any]:
    ...
    return dict(
        ...
        packages=find_packages(where="src", include=["lightning.lightning_app", "lightning.lightning_app.*"]),
        package_dir={"": "src"},
        ...
        entry_points={
            "console_scripts": [
                "lightning = lightning.lightning_app.cli.lightning_cli:main",
            ],
        },
        setup_requires=[],
