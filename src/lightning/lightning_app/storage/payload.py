...
from lightning.lightning_app.core.constants import REMOTE_STORAGE_WAIT
from lightning.lightning_app.core.queues import BaseQueue
from lightning.lightning_app.storage.path import _filesystem, _shared_storage_path, Path
from lightning.lightning_app.storage.requests import _ExistsRequest, _ExistsResponse, _GetRequest, _GetResponse
from lightning.lightning_app.utilities.app_helpers import Logger
from lightning.lightning_app.utilities.component import _is_flow_context
...
class _BasePayload(ABC):
    ...
    def _handle_get_request(work: "LightningWork", request: _GetRequest) -> _GetResponse:
        from lightning.lightning_app.storage.copier import _copy_files
...
class Payload(_BasePayload):
    ...
    :class:`~lightning.lightning_app.storage.path.Path`."""
