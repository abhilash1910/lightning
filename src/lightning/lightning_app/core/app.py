...
from lightning.lightning_app import _console
from lightning.lightning_app.api.request_types import _APIRequest, _CommandRequest, _DeltaRequest
from lightning.lightning_app.core.constants import (
    DEBUG_ENABLED,
...
from lightning.lightning_app.core.queues import BaseQueue
from lightning.lightning_app.core.work import LightningWork
from lightning.lightning_app.frontend import Frontend
from lightning.lightning_app.storage import Drive, Path, Payload
from lightning.lightning_app.storage.path import _storage_root_dir
from lightning.lightning_app.utilities import frontend
from lightning.lightning_app.utilities.app_helpers import (
...
from lightning.lightning_app.utilities.app_status import AppStatus
from lightning.lightning_app.utilities.commands.base import _process_requests
from lightning.lightning_app.utilities.component import _convert_paths_after_init, _validate_root_flow
from lightning.lightning_app.utilities.enum import AppStage, CacheCallsKeys
from lightning.lightning_app.utilities.exceptions import CacheMissException, ExitAppException
from lightning.lightning_app.utilities.layout import _collect_layout
from lightning.lightning_app.utilities.proxies import ComponentDelta
from lightning.lightning_app.utilities.scheduler import SchedulerThread
from lightning.lightning_app.utilities.tree import breadth_first
from lightning.lightning_app.utilities.warnings import LightningFlowWarning

if TYPE_CHECKING:
    from lightning.lightning_app.core.flow import LightningFlow
    from lightning.lightning_app.runners.backends.backend import Backend, WorkManager
    from lightning.lightning_app.runners.runtime import Runtime
...
class LightningApp:
    def __init__(
        ...
        flow_cloud_compute: Optional["lightning.lightning_app.CloudCompute"] = None,
        log_level: str = "info",
        ...
        applications. There are two kinds of components: :class:`~lightning.lightning_app.core.flow.LightningFlow` and
        :class:`~lightning.lightning_app.core.work.LightningWork`. This modular design enables you to reuse components
        created by other users.

        The Lightning App alternatively run an event loop triggered by delta changes sent from
        either :class:`~lightning.lightning_app.core.work.LightningWork` or from the Lightning UI.
        Once deltas are received, the Lightning App runs
        the :class:`~lightning.lightning_app.core.flow.LightningFlow` provided.
        ...
        Example:
            ...
            >>> from lightning.lightning_app import LightningFlow, LightningApp
            >>> from lightning.lightning_app.runners import MultiProcessRuntime
        ...
        from lightning.lightning_app.core.flow import _RootFlow
        ...
        self._root = root
        self.flow_cloud_compute = flow_cloud_compute or lightning.lightning_app.CloudCompute(name="flow-lite")
    ...
    def get_component_by_name(self, component_name: str):
        ...
        from lightning.lightning_app.structures import Dict as LightningDict
        from lightning.lightning_app.structures import List as LightningList
        from lightning.lightning_app.utilities.types import ComponentTuple
    ...
    def _update_layout(self) -> None:
        ...
        for component in breadth_first(self.root, types=(lightning.lightning_app.LightningFlow,)):
    ...
    def _update_status(self) -> None:
        ...
        work_statuses = {}
        for work in breadth_first(self.root, types=(lightning.lightning_app.LightningWork,)):
