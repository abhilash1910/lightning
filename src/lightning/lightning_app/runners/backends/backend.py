...
from lightning.lightning_app.utilities.proxies import ProxyWorkRun, unwrap
...
class Backend(ABC):
    ...
    @abstractmethod
    def create_work(self, app: "lightning.lightning_app.LightningApp", work: "lightning.lightning_app.LightningWork") -> None:
        pass

    @abstractmethod
    def update_work_statuses(self, works: List["lightning.lightning_app.LightningWork"]) -> None:
        pass
    ...
    def _dynamic_run_wrapper(
        self,
        *args: Any,
        app: "lightning.lightning_app.LightningApp",
        work: "lightning.lightning_app.LightningWork",
        work_run: Callable,
        **kwargs: Any,
    ) -> None:
        if not work.name:
    ...
    def _wrap_run_method(self, app: "lightning.lightning_app.LightningApp", work: "lightning.lightning_app.LightningWork"):
    ...
    def _prepare_queues(self, app: "lightning.lightning_app.LightningApp"):
...
class WorkManager(ABC):
    ...
    def __init__(self, app: "lightning.lightning_app.LightningApp", work: "lightning.lightning_app.LightningWork"):
        pass
