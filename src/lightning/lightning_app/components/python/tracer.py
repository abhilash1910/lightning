...
from lightning.lightning_app.storage.drive import Drive
from lightning.lightning_app.storage.payload import Payload
from lightning.lightning_app.utilities.app_helpers import _collect_child_process_pids, Logger
from lightning.lightning_app.utilities.packaging.tarfile import clean_tarfile, extract_tarfile
from lightning.lightning_app.utilities.tracer import Tracer
...
class TracerPythonScript(LightningWork):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        When subclassing this class, you can configure your own :class:`~lightning.lightning_app.utilities.tracer.Tracer`
        by :meth:`~lightning.lightning_app.components.python.tracer.TracerPythonScript.configure_tracer` method.
        ...
        **How does it work?**
        ...
        Example:
            ...
            >>> from lightning.lightning_app.components.python import TracerPythonScript
            >>> f = open("a.py", "w")
        ...
        In the example below, we subclass the  :class:`~lightning.lightning_app.components.python.TracerPythonScript`
