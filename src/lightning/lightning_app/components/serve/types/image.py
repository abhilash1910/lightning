...
from lightning.lightning_app.components.serve.types.type import BaseType
from lightning.lightning_app.utilities.imports import _is_pil_available, _is_torch_available
