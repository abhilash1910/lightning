...
from lightning.lightning_fabric import Fabric
from lightning.lightning_fabric.connector import _PLUGIN_INPUT as _LITE_PLUGIN_INPUT
from lightning.lightning_fabric.connector import _PRECISION_INPUT
from lightning.lightning_fabric.plugins import CheckpointIO, ClusterEnvironment
from lightning.lightning_fabric.plugins import DeepSpeedPrecision as LiteDeepSpeedPrecision
from lightning.lightning_fabric.plugins import DoublePrecision as LiteDoublePrecision
from lightning.lightning_fabric.plugins import MixedPrecision as LiteMixedPrecision
from lightning.lightning_fabric.plugins import Precision as LitePrecision
from lightning.lightning_fabric.plugins import TPUBf16Precision as LiteTPUBf16Precision
from lightning.lightning_fabric.plugins import TPUPrecision as LiteTPUPrecision
from lightning.lightning_fabric.strategies import DataParallelStrategy as LiteDataParallelStrategy
from lightning.lightning_fabric.strategies import DDPShardedStrategy as LiteDDPShardedStrategy
from lightning.lightning_fabric.strategies import DDPStrategy as LiteDDPStrategy
from lightning.lightning_fabric.strategies import DeepSpeedStrategy as LiteDeepSpeedStrategy
from lightning.lightning_fabric.strategies import SingleDeviceStrategy as LiteSingleDeviceStrategy
from lightning.lightning_fabric.strategies import SingleTPUStrategy as LiteSingleTPUStrategy
from lightning.lightning_fabric.strategies import Strategy as LiteStrategy
from lightning.lightning_fabric.strategies import XLAStrategy
from lightning.pytorch_lightning.accelerators import Accelerator as PLAccelerator
from lightning.pytorch_lightning.plugins import DeepSpeedPrecisionPlugin as PLDeepSpeedPrecisionPlugin
from lightning.pytorch_lightning.plugins import DoublePrecisionPlugin as PLDoublePrecisionPlugin
from lightning.pytorch_lightning.plugins import MixedPrecisionPlugin as PLMixedPrecisionPlugin
from lightning.pytorch_lightning.plugins import PrecisionPlugin as PLPrecisionPlugin
from lightning.pytorch_lightning.plugins import TPUBf16PrecisionPlugin as PLTPUBf16PrecisionPlugin
from lightning.pytorch_lightning.plugins import TPUPrecisionPlugin as PLTPUPrecisionPlugin
from lightning.pytorch_lightning.strategies import DataParallelStrategy as PLDataParallelStrategy
from lightning.pytorch_lightning.strategies import DDPShardedStrategy as PLDDPShardedStrategy
from lightning.pytorch_lightning.strategies import DDPSpawnShardedStrategy as PLDDPSpawnShardedStrategy
from lightning.pytorch_lightning.strategies import DDPSpawnStrategy as PLDDPSpawnStrategy
from lightning.pytorch_lightning.strategies import DDPStrategy as PLDDPStrategy
from lightning.pytorch_lightning.strategies import DeepSpeedStrategy as PLDeepSpeedStrategy
from lightning.pytorch_lightning.strategies import SingleDeviceStrategy as PLSingleDeviceStrategy
from lightning.pytorch_lightning.strategies import SingleTPUStrategy as PLSingleTPUStrategy
from lightning.pytorch_lightning.strategies import Strategy as PLStrategy
from lightning.pytorch_lightning.strategies import TPUSpawnStrategy as PLTPUSpawnStrategy
from lightning.pytorch_lightning.utilities.rank_zero import rank_zero_deprecation, rank_zero_warn
...
def _convert_deprecated_device_flags(
    ...
    Similar implementation as in ``lightning.pytorch_lightning.trainer.connectors.accelerator_connector``.
    """
    if gpus is not None:
