...
from lightning.pytorch_lightning.callbacks import Checkpoint
from lightning.pytorch_lightning.utilities.exceptions import MisconfigurationException
from lightning.pytorch_lightning.utilities.rank_zero import rank_zero_info, rank_zero_warn, WarningCache
...
class ModelCheckpoint(Checkpoint):
    ...
    :meth:`~lightning.pytorch_lightning.core.module.log` or :meth:`~lightning.pytorch_lightning.core.module.log_dict` in
    ...
    Args:
        dirpath: directory to save the model file.
            ...
            specified by :class:`~lightning.pytorch_lightning.trainer.trainer.Trainer`'s
            :paramref:`~lightning.pytorch_lightning.trainer.trainer.Trainer.default_root_dir` argument,
