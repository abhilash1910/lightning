...
from lightning.pytorch_lightning.utilities.imports import _RICH_AVAILABLE
from lightning.pytorch_lightning.utilities.model_summary import get_human_readable_count
...
class RichModelSummary(ModelSummary):
    ...
    .. code-block:: python
        ...
        from lightning.pytorch_lightning.callbacks import RichModelSummary

        trainer = Trainer(callbacks=RichModelSummary())

    You could also enable ``RichModelSummary`` using the :class:`~lightning.pytorch_lightning.callbacks.RichProgressBar`

    .. code-block:: python

        from lightning.pytorch_lightning import Trainer
        from lightning.pytorch_lightning.callbacks import RichProgressBar
