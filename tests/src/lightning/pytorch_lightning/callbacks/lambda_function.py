...
class LambdaCallback(Callback):
    ...
    Args:
        **kwargs: hooks supported by :class:`~lightning.pytorch_lightning.callbacks.callback.Callback`

    Example::

        >>> from lightning.pytorch_lightning import Trainer
        >>> from lightning.pytorch_lightning.callbacks import LambdaCallback
