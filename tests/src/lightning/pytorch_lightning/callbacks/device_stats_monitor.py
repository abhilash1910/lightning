...
from lightning.pytorch_lightning.utilities.imports import _PSUTIL_AVAILABLE
...
class DeviceStatsMonitor(Callback):
    ...
    Example:
        ...
        >>> from lightning.pytorch_lightning.callbacks import DeviceStatsMonitor
    ...
    def _get_and_log_device_stats(self, trainer: "pl.Trainer", key: str) -> None:
        ...
        if self._cpu_stats and device.type != "cpu":
            ...
            from lightning.pytorch_lightning.accelerators.cpu import get_cpu_stats
