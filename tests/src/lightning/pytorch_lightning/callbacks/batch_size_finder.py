...
from lightning.pytorch_lightning.tuner.batch_size_scaling import scale_batch_size
from lightning.pytorch_lightning.utilities.exceptions import _TunerExitException, MisconfigurationException
from lightning.pytorch_lightning.utilities.parsing import lightning_hasattr
...
class BatchSizeFinder(Callback):
    ...
    Example::
        ...
        from lightning.pytorch_lightning.callbacks import BatchSizeFinder
