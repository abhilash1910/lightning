...
from lightning.lightning_fabric.utilities.distributed import _all_gather_ddp_if_available, ReduceOp
from lightning.pytorch_lightning.plugins import LayerSync
