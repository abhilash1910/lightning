...
from lightning.lightning_fabric.strategies.launchers.multiprocessing import _check_bad_cuda_fork
...
from lightning.pytorch_lightning.trainer.states import TrainerFn, TrainerState
from lightning.pytorch_lightning.utilities.rank_zero import rank_zero_debug
...
class _MultiProcessingLauncher(_Launcher):
    ...
    def launch(self, function: Callable, *args: Any, trainer: Optional["pl.Trainer"] = None, **kwargs: Any) -> Any:
        ...
        Arguments:
            ...
            *args: Optional positional arguments to be passed to the given function.
            trainer: Optional reference to the :class:`~lightning.pytorch_lightning.trainer.trainer.Trainer` for which
    ...
    def _check_torchdistx_support(self) -> None:
        if self._start_method == "spawn":
            from lightning.pytorch_lightning.utilities.meta import _is_deferred
