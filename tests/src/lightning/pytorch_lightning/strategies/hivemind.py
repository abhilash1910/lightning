...
from lightning.lightning_fabric.utilities.types import LRScheduler, ReduceLROnPlateau
from lightning.pytorch_lightning.strategies.strategy import Strategy, TBroadcast
...
from lightning.pytorch_lightning.utilities.imports import _HIVEMIND_AVAILABLE
        ...
        **optimizer_kwargs: Any,
        ...
        Arguments:
            ...
            delay_optimizer_step: Run optimizer in background, apply results in future .step. requires
                :paramref:`~lightning.pytorch_lightning.strategies.hivemind.HivemindStrategy.offload_optimizer`.

            delay_grad_averaging: Average gradients in background; requires
                :paramref:`~lightning.pytorch_lightning.strategies.hivemind.HivemindStrategy.offload_optimizer` and
                :paramref:`~lightning.pytorch_lightning.strategies.hivemind.HivemindStrategy.delay_optimizer_step`.
