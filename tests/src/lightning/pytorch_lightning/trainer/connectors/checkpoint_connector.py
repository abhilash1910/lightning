...
from lightning.lightning_fabric.plugins.environments.slurm import SLURMEnvironment
...
from lightning.pytorch_lightning.callbacks import ModelCheckpoint
from lightning.pytorch_lightning.plugins.precision import ApexMixedPrecisionPlugin, MixedPrecisionPlugin
from lightning.pytorch_lightning.trainer.states import TrainerFn
from lightning.pytorch_lightning.utilities import _OMEGACONF_AVAILABLE
...
from lightning.pytorch_lightning.utilities.migration import pl_legacy_patch
from lightning.pytorch_lightning.utilities.migration.utils import _pl_migrate_checkpoint
...
class CheckpointConnector:
    ...
    def _set_ckpt_path(
        ...
        from lightning.pytorch_lightning.callbacks.fault_tolerance import _FaultToleranceCheckpoint
    ...
    def _restore_quantization_callbacks(self) -> None:
        ...
        from lightning.pytorch_lightning.callbacks.quantization import QuantizationAwareTraining  # avoid circular import
