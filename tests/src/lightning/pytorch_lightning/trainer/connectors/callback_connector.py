...
from lightning.pytorch_lightning.callbacks import (
    Callback,
    Checkpoint,
...
from lightning.pytorch_lightning.utilities.imports import _PYTHON_GREATER_EQUAL_3_8_0, _PYTHON_GREATER_EQUAL_3_10_0
from lightning.pytorch_lightning.utilities.model_helpers import is_overridden
from lightning.pytorch_lightning.utilities.rank_zero import rank_zero_info
...
class CallbackConnector:
    ...
    def _attach_model_callbacks(self) -> None:
        ...
        In addition, all :class:`~lightning.pytorch_lightning.callbacks.model_checkpoint.ModelCheckpoint` callbacks
...
def _configure_external_callbacks() -> List[Callback]:
    ...
    """
    group = "lightning.pytorch_lightning.callbacks_factory"
