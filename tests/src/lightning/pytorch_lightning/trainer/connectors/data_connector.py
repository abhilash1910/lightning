...
from lightning.lightning_fabric.utilities.data import _auto_add_worker_init_fn, _replace_dunder_methods, has_iterable_dataset
from lightning.lightning_fabric.utilities.distributed import DistributedSamplerWrapper
from lightning.pytorch_lightning.accelerators.ipu import IPUAccelerator
from lightning.pytorch_lightning.overrides.distributed import UnrepeatedDistributedSamplerWrapper
from lightning.pytorch_lightning.strategies import DDPSpawnStrategy
from lightning.pytorch_lightning.trainer.states import RunningStage, TrainerFn
from lightning.pytorch_lightning.trainer.supporters import CombinedLoader, CycleIterator
from lightning.pytorch_lightning.utilities.auto_restart import _validate_fault_tolerant_automatic
from lightning.pytorch_lightning.utilities.data import _is_dataloader_shuffled, _update_dataloader, has_len_all_ranks
...
from lightning.pytorch_lightning.utilities.rank_zero import rank_zero_warn, WarningCache
from lightning.pytorch_lightning.utilities.types import EVAL_DATALOADERS, TRAIN_DATALOADERS
from lightning.pytorch_lightning.utilities.warnings import PossibleUserWarning
...
class _DataLoaderSource:
    ...
    1. from a ``*_datalaoder()`` method on the :class:`~lightning.pytorch_lightning.core.module.LightningModule`,
    2. from a ``*_datalaoder()`` method on the :class:`~lightning.pytorch_lightning.core.datamodule.LightningDataModule`,
...
class _DataHookSelector:
    ...
    1. the :class:`~lightning.pytorch_lightning.core.module.LightningModule`,
    2. the :class:`~lightning.pytorch_lightning.core.datamodule.LightningDataModule`,
