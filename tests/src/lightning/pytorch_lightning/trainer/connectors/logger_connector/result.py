...
from lightning.lightning_fabric.utilities.distributed import _distributed_available
from lightning.pytorch_lightning.utilities.data import extract_batch_size
...
from lightning.pytorch_lightning.utilities.memory import recursive_detach
from lightning.pytorch_lightning.utilities.metrics import metrics_to_scalars
...
class _ResultMetric(Metric, _DeviceDtypeModuleMixin):
    """Wraps the value provided to `:meth:`~lightning.pytorch_lightning.core.module.LightningModule.log`"""
...
class _ResultMetricCollection(dict):
    ...
    :class:`~lightning.pytorch_lightning.trainer.connectors.logger_connector.result._ResultMetric`
...
class _ResultCollection(dict):
    """
    Collection (dictionary) of :class:`~lightning.pytorch_lightning.trainer.connectors.logger_connector.result._ResultMetric` or
    :class:`~lightning.pytorch_lightning.trainer.connectors.logger_connector.result._ResultMetricCollection`
    ...
    def log(
        ...
        """See :meth:`~lightning.pytorch_lightning.core.module.LightningModule.log`"""
