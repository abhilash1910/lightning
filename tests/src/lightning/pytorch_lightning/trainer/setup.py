...
from lightning.pytorch_lightning.accelerators import (
    CUDAAccelerator,
    HPUAccelerator,
    IPUAccelerator,
    MPSAccelerator,
...
from lightning.pytorch_lightning.profilers import (
    AdvancedProfiler,
    PassThroughProfiler,
    Profiler,
    PyTorchProfiler,
...
from lightning.pytorch_lightning.utilities import _HPU_AVAILABLE, _IPU_AVAILABLE
