...
from lightning.pytorch_lightning.accelerators import CUDAAccelerator
from lightning.pytorch_lightning.loops import Loop
from lightning.pytorch_lightning.loops.epoch import TrainingEpochLoop
from lightning.pytorch_lightning.loops.epoch.training_epoch_loop import _OUTPUTS_TYPE as _EPOCH_OUTPUTS_TYPE
from lightning.pytorch_lightning.loops.utilities import _is_max_limit_reached, _set_sampler_epoch
from lightning.pytorch_lightning.trainer.connectors.logger_connector.result import _ResultCollection
from lightning.pytorch_lightning.trainer.progress import Progress
from lightning.pytorch_lightning.trainer.supporters import CombinedLoader, TensorRunningAccum
from lightning.pytorch_lightning.utilities.exceptions import MisconfigurationException
from lightning.pytorch_lightning.utilities.fetching import (
    AbstractDataFetcher,
    DataFetcher,
...
from lightning.pytorch_lightning.utilities.rank_zero import rank_zero_debug, rank_zero_info, rank_zero_warn
