...
from lightning.pytorch_lightning import loops  # import as loops to avoid circular imports
from lightning.pytorch_lightning.loops.batch import TrainingBatchLoop
from lightning.pytorch_lightning.loops.batch.training_batch_loop import _OUTPUTS_TYPE as _BATCH_OUTPUTS_TYPE
from lightning.pytorch_lightning.loops.utilities import _get_active_optimizers, _is_max_limit_reached
from lightning.pytorch_lightning.trainer.connectors.logger_connector.result import _ResultCollection
from lightning.pytorch_lightning.trainer.progress import BatchProgress, SchedulerProgress
from lightning.pytorch_lightning.trainer.supporters import CombinedLoader
from lightning.pytorch_lightning.utilities.auto_restart import _collect_states_on_rank_zero_over_collection
from lightning.pytorch_lightning.utilities.exceptions import MisconfigurationException
from lightning.pytorch_lightning.utilities.fetching import AbstractDataFetcher, DataLoaderIterDataFetcher
