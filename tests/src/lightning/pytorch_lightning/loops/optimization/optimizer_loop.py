...
from lightning.pytorch_lightning.accelerators import TPUAccelerator
from lightning.pytorch_lightning.core.optimizer import LightningOptimizer
from lightning.pytorch_lightning.loops import Loop
from lightning.pytorch_lightning.loops.optimization.closure import AbstractClosure, OutputResult
from lightning.pytorch_lightning.loops.utilities import (
    _block_parallel_sync_behavior,
    _build_training_step_kwargs,
    _extract_hiddens,
)
from lightning.pytorch_lightning.plugins import ApexMixedPrecisionPlugin
from lightning.pytorch_lightning.plugins.precision.native_amp import MixedPrecisionPlugin
from lightning.pytorch_lightning.trainer.progress import OptimizationProgress
from lightning.pytorch_lightning.utilities.exceptions import MisconfigurationException
from lightning.pytorch_lightning.utilities.rank_zero import rank_zero_deprecation, WarningCache
...
class ClosureResult(OutputResult):
    ...
    It is created from the output of :meth:`~lightning.pytorch_lightning.core.module.LightningModule.training_step`.
...
class Closure(AbstractClosure[ClosureResult]):
    ...
    Args:
        step_fn: This is typically the :meth:`lightning.pytorch_lightning.core.module.LightningModule.training_step
