...
from lightning.pytorch_lightning.core.optimizer import do_nothing_closure
from lightning.pytorch_lightning.loops import Loop
from lightning.pytorch_lightning.loops.optimization.closure import OutputResult
from lightning.pytorch_lightning.loops.utilities import _build_training_step_kwargs, _extract_hiddens
from lightning.pytorch_lightning.trainer.progress import Progress, ReadyCompletedTracker
...
class ManualOptimization(Loop[_OUTPUTS_TYPE]):
    ...
    entirely in the :meth:`~lightning.pytorch_lightning.core.module.LightningModule.training_step` and therefore the user is
    ...
    :meth:`~lightning.pytorch_lightning.core.module.LightningModule.training_step`) and passing through the output(s).
    """
