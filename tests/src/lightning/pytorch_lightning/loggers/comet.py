...
class CometLogger(Logger):
    ...
    `Comet <https://www.comet.com/?utm_source=lightning.pytorch_lightning&utm_medium=referral>`_.
    ...
    **ONLINE MODE**
    ...
    .. code-block:: python
        ...
        from lightning.pytorch_lightning.loggers import CometLogger
    ...
    **Log Hyperparameters:**
    ...
    Log parameters used to initialize a :class:`~lightning.pytorch_lightning.core.module.LightningModule`:
