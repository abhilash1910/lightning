...
from lightning.lightning_fabric.utilities.logger import _add_prefix, _convert_params, _flatten_dict, _sanitize_callable_params
...
from lightning.pytorch_lightning.loggers.logger import Logger, rank_zero_experiment
from lightning.pytorch_lightning.utilities.exceptions import MisconfigurationException
from lightning.pytorch_lightning.utilities.logger import _scan_checkpoints
from lightning.pytorch_lightning.utilities.rank_zero import rank_zero_only, rank_zero_warn
...
class WandbLogger(Logger):
    ...
    **Installation and set-up**
    ...
    .. code-block:: python
        ...
        from lightning.pytorch_lightning.loggers import WandbLogger
    ...
    **Log metrics**
    ...
    Log from :class:`~lightning.pytorch_lightning.core.module.LightningModule`:
    ...
    **Log hyper-parameters**
    ...
    Save :class:`~lightning.pytorch_lightning.core.module.LightningModule` parameters:
    ...
    **Log model checkpoints**
    ...
    Custom checkpointing can be set up through :class:`~lightning.pytorch_lightning.callbacks.ModelCheckpoint`:
    ...
    **Downloading and Using Artifacts**
    ...
    Args:
        ...
        log_model: Log checkpoints created by :class:`~lightning.pytorch_lightning.callbacks.ModelCheckpoint`
            as W&B artifacts. `latest` and `best` aliases are automatically set.

            * if ``log_model == 'all'``, checkpoints are logged during training.
            * if ``log_model == True``, checkpoints are logged at the end of training, except when
              :paramref:`~lightning.pytorch_lightning.callbacks.ModelCheckpoint.save_top_k` ``== -1``
    ...
    def experiment(self) -> Union[Run, RunDisabled]:
        ...
        :class:`~lightning.pytorch_lightning.core.module.LightningModule` do the following.
