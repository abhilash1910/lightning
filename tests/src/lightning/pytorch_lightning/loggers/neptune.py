...
from lightning.lightning_fabric.utilities.logger import _add_prefix, _convert_params, _sanitize_callable_params
...
from lightning.pytorch_lightning.utilities.model_summary import ModelSummary
...
class NeptuneLogger(Logger):
    ...
    **Quickstart**
    ...
    .. code-block:: python
        ...
        from lightning.pytorch_lightning.loggers import NeptuneLogger
    ...
    **Log model checkpoints**
    ...
    If you have :class:`~lightning.pytorch_lightning.callbacks.ModelCheckpoint` configured,
    ...
    **Details about Neptune run structure**
    ...
    def experiment(self) -> Run:
        ...
        :class:`~lightning.pytorch_lightning.core.module.LightningModule`.
