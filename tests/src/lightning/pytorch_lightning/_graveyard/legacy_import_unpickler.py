...
def _patch_pl_to_mirror_if_necessary(module: str) -> str:
    ...
    if module.startswith(pl):
        ...
        module = "lightning.pytorch_lightning" + module[len(pl) :]
    return module
...
# patching is necessary, since up to v.0.7.3 torchmetrics has a hardcoded reference to lightning.pytorch_lightning,
