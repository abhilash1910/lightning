...
from lightning.pytorch_lightning.utilities.memory import garbage_collection_cuda, is_oom_error
from lightning.pytorch_lightning.utilities.parsing import lightning_getattr, lightning_setattr
from lightning.pytorch_lightning.utilities.rank_zero import rank_zero_info, rank_zero_warn
...
def _adjust_batch_size(
    ...
    Args:
        trainer: instance of lightning.pytorch_lightning.Trainer
