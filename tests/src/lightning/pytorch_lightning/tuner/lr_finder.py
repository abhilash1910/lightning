...
from lightning.pytorch_lightning.callbacks import Callback
from lightning.pytorch_lightning.utilities.exceptions import MisconfigurationException
from lightning.pytorch_lightning.utilities.parsing import lightning_hasattr, lightning_setattr
from lightning.pytorch_lightning.utilities.rank_zero import rank_zero_warn
from lightning.pytorch_lightning.utilities.types import LRScheduler, LRSchedulerConfig, STEP_OUTPUT
...
class _LRFinder:
    ...
    def _exchange_scheduler(self, trainer: "pl.Trainer") -> None:
        ...
        from lightning.pytorch_lightning.core.optimizer import _set_scheduler_opt_idx
...
def lr_find(
    ...
    """See :meth:`~lightning.pytorch_lightning.tuner.tuning.Tuner.lr_find`"""
...
def __lr_finder_reset_params(trainer: "pl.Trainer", num_training: int, early_stop_threshold: Optional[float]) -> None:
    from lightning.pytorch_lightning.loggers.logger import DummyLogger
