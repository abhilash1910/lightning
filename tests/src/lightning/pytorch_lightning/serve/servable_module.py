...
class ServableModule(torch.nn.Module):
    ...
    .. code-block:: python
        ...
        from lightning.pytorch_lightning.demos.boring_classes import BoringModel
        from lightning.pytorch_lightning.serve.servable_module_validator import ServableModule, ServableModuleValidator
