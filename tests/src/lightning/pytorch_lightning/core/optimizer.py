...
from lightning.lightning_fabric.utilities.types import _Stateful, Optimizable, ReduceLROnPlateau
...
from lightning.pytorch_lightning.utilities.types import LRSchedulerConfig, LRSchedulerTypeTuple
...
class LightningOptimizer:
    ...
    def toggle_model(self, sync_grad: bool = True) -> Generator[None, None, None]:
        ...
        from lightning.pytorch_lightning.loops.utilities import _block_parallel_sync_behavior
