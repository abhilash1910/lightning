...
from lightning.pytorch_lightning.core.hooks import DataHooks
from lightning.pytorch_lightning.core.mixins import HyperparametersMixin
from lightning.pytorch_lightning.core.saving import _load_from_checkpoint
...
from lightning.pytorch_lightning.utilities.types import _ADD_ARGPARSE_RETURN, EVAL_DATALOADERS, TRAIN_DATALOADERS
    ...
    def from_argparse_args(
        ...
        Args:
            args: The parser or namespace to take arguments from. Only known arguments will be
                parsed and passed to the :class:`~lightning.pytorch_lightning.core.datamodule.LightningDataModule`.
