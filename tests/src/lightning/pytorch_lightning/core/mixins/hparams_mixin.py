...
from lightning.pytorch_lightning.core.saving import ALLOWED_CONFIG_TYPES, PRIMITIVE_TYPES
from lightning.pytorch_lightning.utilities.parsing import AttributeDict, save_hyperparameters
