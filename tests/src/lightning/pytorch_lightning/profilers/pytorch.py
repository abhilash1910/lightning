...
from lightning.lightning_fabric.accelerators.cuda import is_cuda_available
from lightning.pytorch_lightning.profilers.profiler import Profiler
from lightning.pytorch_lightning.utilities.exceptions import MisconfigurationException
from lightning.pytorch_lightning.utilities.imports import _KINETO_AVAILABLE
...
if TYPE_CHECKING:
    ...
    from lightning.pytorch_lightning.core.module import LightningModule
...
class RegisterRecordFunction:
    ...
    Example::
        from lightning.pytorch_lightning.profilers import PyTorchProfiler
    ...
    Example::
        from lightning.pytorch_lightning import Trainer, seed_everything
        ...
        **profiler_kwargs: Any,
        ...
        Args:
            dirpath: Directory path for the ``filename``. If ``dirpath`` is ``None`` but ``filename`` is present, the
                ``trainer.log_dir`` (from :class:`~lightning.pytorch_lightning.loggers.tensorboard.TensorBoardLogger`)
                will be used.
