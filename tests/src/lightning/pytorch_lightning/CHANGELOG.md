...
- Deprecated `lightning.pytorch_lightning.profiler` in favor of `lightning.pytorch_lightning.profilers` ([#16059](https://github.com/PyTorchLightning/pytorch-lightning/pull/16059))


- Deprecated `Trainer(auto_select_gpus=...)` in favor of `lightning.pytorch_lightning.accelerators.find_usable_cuda_devices` ([#16147](https://github.com/PyTorchLightning/pytorch-lightning/pull/16147))


- Deprecated `lightning.pytorch_lightning.tuner.auto_gpu_select.{pick_single_gpu,pick_multiple_gpus}` in favor of `lightning.pytorch_lightning.accelerators.find_usable_cuda_devices` ([#16147](https://github.com/PyTorchLightning/pytorch-lightning/pull/16147))


- `nvidia/apex` deprecation ([#16039](https://github.com/PyTorchLightning/pytorch-lightning/pull/16039))
  * Deprecated `lightning.pytorch_lightning.plugins.NativeMixedPrecisionPlugin` in favor of `lightning.pytorch_lightning.plugins.MixedPrecisionPlugin`
  ...
  * Deprecated the `lightning.pytorch_lightning.plugins.ApexMixedPrecisionPlugin` class
  * Deprecates the `lightning.pytorch_lightning.utilities.enum.sAMPType` enum
...
- Removed deprecated `lightning.pytorch_lightning.utilities.memory.get_gpu_memory_map` in favor of `lightning.pytorch_lightning.accelerators.cuda.get_nvidia_gpu_stats` ([#15617](https://github.com/Lightning-AI/lightning/pull/15617))


- Temporarily removed support for Hydra multi-run ([#15737](https://github.com/Lightning-AI/lightning/pull/15737))


- Removed deprecated `lightning.pytorch_lightning.profiler.base.AbstractProfiler` in favor of `lightning.pytorch_lightning.profilers.profiler.Profiler` ([#15637](https://github.com/Lightning-AI/lightning/pull/15637))


- Removed deprecated `lightning.pytorch_lightning.profiler.base.BaseProfiler` in favor of `lightning.pytorch_lightning.profilers.profiler.Profiler` ([#15637](https://github.com/Lightning-AI/lightning/pull/15637))


- Removed deprecated code in `lightning.pytorch_lightning.utilities.meta` ([#16038](https://github.com/Lightning-AI/lightning/pull/16038))


- Removed the deprecated `LightningDeepSpeedModule` ([#16041](https://github.com/Lightning-AI/lightning/pull/16041))


- Removed the deprecated `lightning.pytorch_lightning.accelerators.GPUAccelerator` in favor of `lightning.pytorch_lightning.accelerators.CUDAAccelerator` ([#16050](https://github.com/Lightning-AI/lightning/pull/16050))


- Removed the deprecated `lightning.pytorch_lightning.profiler.*` classes in favor of `lightning.pytorch_lightning.profilers` ([#16059](https://github.com/PyTorchLightning/pytorch-lightning/pull/16059))


- Removed the deprecated `lightning.pytorch_lightning.utilities.cli` module in favor of `lightning.pytorch_lightning.cli` ([#16116](https://github.com/PyTorchLightning/pytorch-lightning/pull/16116))


- Removed the deprecated `lightning.pytorch_lightning.loggers.base` module in favor of `lightning.pytorch_lightning.loggers.logger` ([#16120](https://github.com/PyTorchLightning/pytorch-lightning/pull/16120))


- Removed the deprecated `lightning.pytorch_lightning.loops.base` module in favor of `lightning.pytorch_lightning.loops.loop` ([#16142](https://github.com/PyTorchLightning/pytorch-lightning/pull/16142))
...
- Added back the accidentally removed `lightning.pytorch_lightning.utilities.distributed.rank_zero_only` function ([#15536](https://github.com/Lightning-AI/lightning/pull/15536))

### Deprecated

- Deprecated `lightning.pytorch_lightning.utilities.distributed.rank_zero_only` in favor of `lightning.pytorch_lightning.utilities.rank_zero_only` ([#15536](https://github.com/Lightning-AI/lightning/pull/15536))
...
- Fixed the import of `lightning.pytorch_lightning` causing a warning 'Redirects are currently not supported in Windows or MacOs' ([#15610](https://github.com/PyTorchLightning/pytorch-lightning/issues/15610))
...
- Deprecated the calls to `lightning.pytorch_lightning.utiltiies.meta` functions in favor of built-in https://github.com/pytorch/torchdistx support ([#13868](https://github.com/Lightning-AI/lightning/pull/13868))
...
- Deprecated all functions in `lightning.pytorch_lightning.utilities.xla_device` ([#14514](https://github.com/Lightning-AI/lightning/pull/14514), [#14550](https://github.com/Lightning-AI/lightning/pull/14550))
  ...
  * Deprecated the `XLADeviceUtils.tpu_device_exists` staticmethod in favor of `lightning.pytorch_lightning.accelerators.TPUAccelerator.is_available()`
- Deprecated `lightning.pytorch_lightning.utilities.distributed.tpu_distributed` in favor of `lightning_lite.accelerators.tpu.tpu_distributed` ([#14550](https://github.com/Lightning-AI/lightning/pull/14550))
- Deprecated all functions in `lightning.pytorch_lightning.utilities.cloud_io` in favor of `lightning_lite.utilities.cloud_io` ([#14515](https://github.com/Lightning-AI/lightning/pull/14515))
- Deprecated the functions in `lightning.pytorch_lightning.utilities.apply_func` in favor of `lightning_utilities.core.apply_func` ([#14516](https://github.com/Lightning-AI/lightning/pull/14516), [#14537](https://github.com/Lightning-AI/lightning/pull/14537))
- Deprecated all functions in `lightning.pytorch_lightning.utilities.device_parser` ([#14492](https://github.com/Lightning-AI/lightning/pull/14492), [#14753](https://github.com/Lightning-AI/lightning/pull/14753))
  * Deprecated the `lightning.pytorch_lightning.utilities.device_parser.determine_root_gpu_device` in favor of `lightning_lite.utilities.device_parser.determine_root_gpu_device`
  * Deprecated the `lightning.pytorch_lightning.utilities.device_parser.parse_gpu_ids` in favor of `lightning_lite.utilities.device_parser.parse_gpu_ids`
  * Deprecated the `lightning.pytorch_lightning.utilities.device_parser.is_cuda_available` in favor of `lightning_lite.accelerators.cuda.is_cuda_available`
  * Deprecated the `lightning.pytorch_lightning.utilities.device_parser.num_cuda_devices` in favor of `lightning_lite.accelerators.cuda.num_cuda_devices`
  * Deprecated the `lightning.pytorch_lightning.utilities.device_parser.parse_cpu_cores` in favor of `lightning_lite.accelerators.cpu.parse_cpu_cores`
  * Deprecated the `lightning.pytorch_lightning.utilities.device_parser.parse_tpu_cores` in favor of `lightning_lite.accelerators.tpu.parse_tpu_cores`
  * Deprecated the `lightning.pytorch_lightning.utilities.device_parser.parse_hpus` in favor of `lightning.pytorch_lightning.accelerators.hpu.parse_hpus`
...
- Removed the experimental `lightning.pytorch_lightning.utiltiies.meta` functions in favor of built-in https://github.com/pytorch/torchdistx support ([#13868](https://github.com/Lightning-AI/lightning/pull/13868))
...
- Removed the deprecated ([#14471](https://github.com/Lightning-AI/lightning/pull/14471))
  * `lightning.pytorch_lightning.utilities.distributed.rank_zero_only` in favor of `lightning.pytorch_lightning.utilities.rank_zero.rank_zero_only`
  * `lightning.pytorch_lightning.utilities.distributed.rank_zero_debug` in favor of `lightning.pytorch_lightning.utilities.rank_zero.rank_zero_debug`
  * `lightning.pytorch_lightning.utilities.distributed.rank_zero_info` in favor of `lightning.pytorch_lightning.utilities.rank_zero.rank_zero_info`
  * `lightning.pytorch_lightning.utilities.warnings.rank_zero_warn` in favor of `lightning.pytorch_lightning.utilities.rank_zero.rank_zero_warn`
  * `lightning.pytorch_lightning.utilities.warnings.rank_zero_deprecation` in favor of `lightning.pytorch_lightning.utilities.rank_zero.rank_zero_deprecation`
  * `lightning.pytorch_lightning.utilities.warnings.LightningDeprecationWarning` in favor of `lightning.pytorch_lightning.utilities.rank_zero.LightningDeprecationWarning`
...
- Include the `lightning.pytorch_lightning` version as a header in the CLI config files ([#12532](https://github.com/Lightning-AI/lightning/pull/12532))
...
- Deprecated `lightning.pytorch_lightning.accelerators.gpu.GPUAccelerator` in favor of `lightning.pytorch_lightning.accelerators.cuda.CUDAAccelerator` ([#13636](https://github.com/Lightning-AI/lightning/pull/13636))
- Deprecated `lightning.pytorch_lightning.loggers.base.LightningLoggerBase` in favor of `lightning.pytorch_lightning.loggers.logger.Logger`, and deprecated `lightning.pytorch_lightning.loggers.base` in favor of `lightning.pytorch_lightning.loggers.logger` ([#120148](https://github.com/Lightning-AI/lightning/pull/12014))
- Deprecated `lightning.pytorch_lightning.callbacks.base.Callback` in favor of `lightning.pytorch_lightning.callbacks.callback.Callback` ([#13031](https://github.com/Lightning-AI/lightning/pull/13031))
...
- Deprecated `lightning.pytorch_lightning.core.lightning.LightningModule` in favor of `lightning.pytorch_lightning.core.module.LightningModule` ([#12740](https://github.com/Lightning-AI/lightning/pull/12740))
- Deprecated `lightning.pytorch_lightning.loops.base.Loop` in favor of `lightning.pytorch_lightning.loops.loop.Loop` ([#13043](https://github.com/Lightning-AI/lightning/pull/13043))
...
- Deprecated public utilities in `lightning.pytorch_lightning.utilities.cli.LightningCLI` in favor of equivalent copies in `lightning.pytorch_lightning.cli.LightningCLI` ([#13767](https://github.com/Lightning-AI/lightning/pull/13767))
- Deprecated `lightning.pytorch_lightning.profiler.*` in favor of `lightning.pytorch_lightning.profilers` ([#12308](https://github.com/Lightning-AI/lightning/pull/12308))
...
- Removed deprecated `lightning.pytorch_lightning.core.decorators.parameter_validation` from `decorators` ([#13514](https://github.com/Lightning-AI/lightning/pull/13514))
...
- Removed the deprecated `lightning.pytorch_lightning.core.memory.LayerSummary` and `lightning.pytorch_lightning.core.memory.ModelSummary` ([#12593](https://github.com/Lightning-AI/lightning/pull/12593))
...
- Removed the deprecated `lightning.pytorch_lightning.core.memory.{get_gpu_memory_map,get_memory_profile}` ([#12659](https://github.com/Lightning-AI/lightning/pull/12659))
...
- Remove deprecated `lightning.pytorch_lightning.callbacks.progress.progress` ([#12658](https://github.com/Lightning-AI/lightning/pull/12658))
...
- Removed deprecated `lightning.pytorch_lightning.callbacks.lr_monitor.LearningRateMonitor.lr_sch_names` ([#13353](https://github.com/Lightning-AI/lightning/pull/13353))
...
- Fixed `lightning.pytorch_lightning.utilities.distributed.gather_all_tensors` to handle tensors of different dimensions ([#12630](https://github.com/Lightning-AI/lightning/pull/12630))
...
- Deprecated function `lightning.pytorch_lightning.callbacks.device_stats_monitor.prefix_metric_keys` ([#11254](https://github.com/Lightning-AI/lightning/pull/11254))
...
- Deprecated `lightning.pytorch_lightning.utilities.distributed.rank_zero_only` in favor of `lightning.pytorch_lightning.utilities.rank_zero.rank_zero_only` ([#11747](https://github.com/Lightning-AI/lightning/pull/11747))
- Deprecated `lightning.pytorch_lightning.utilities.distributed.rank_zero_debug` in favor of `lightning.pytorch_lightning.utilities.rank_zero.rank_zero_debug` ([#11747](https://github.com/Lightning-AI/lightning/pull/11747))
- Deprecated `lightning.pytorch_lightning.utilities.distributed.rank_zero_info` in favor of `lightning.pytorch_lightning.utilities.rank_zero.rank_zero_info` ([#11747](https://github.com/Lightning-AI/lightning/pull/11747))
- Deprecated `lightning.pytorch_lightning.utilities.warnings.rank_zero_warn` in favor of `lightning.pytorch_lightning.utilities.rank_zero.rank_zero_warn` ([#11747](https://github.com/Lightning-AI/lightning/pull/11747))
- Deprecated `lightning.pytorch_lightning.utilities.warnings.rank_zero_deprecation` in favor of `lightning.pytorch_lightning.utilities.rank_zero.rank_zero_deprecation` ([#11747](https://github.com/Lightning-AI/lightning/pull/11747))
- Deprecated `lightning.pytorch_lightning.utilities.warnings.LightningDeprecationWarning` in favor of `lightning.pytorch_lightning.utilities.rank_zero.LightningDeprecationWarning` ([#11747](https://github.com/Lightning-AI/lightning/pull/11747))
...
- Deprecated `lightning.pytorch_lightning.profiler.AbstractProfiler` in favor of `lightning.pytorch_lightning.profiler.Profiler` ([#12106](https://github.com/Lightning-AI/lightning/pull/12106))
- Deprecated `lightning.pytorch_lightning.profiler.BaseProfiler` in favor of `lightning.pytorch_lightning.profiler.Profiler` ([#12150](https://github.com/Lightning-AI/lightning/pull/12150))
...
- Removed deprecated parameter `method` in `lightning.pytorch_lightning.utilities.model_helpers.is_overridden` ([#10507](https://github.com/Lightning-AI/lightning/pull/10507))
...
- Removed deprecated `lightning.pytorch_lightning.utilities.device_dtype_mixin.DeviceDtypeModuleMixin` in favor of `lightning.pytorch_lightning.core.mixins.device_dtype_mixin.DeviceDtypeModuleMixin` ([#10442](https://github.com/Lightning-AI/lightning/pull/10442))
...
- Removed deprecated `import lightning.pytorch_lightning.profiler.profilers` in favor of `import lightning.pytorch_lightning.profiler` ([#10443](https://github.com/Lightning-AI/lightning/pull/10443))
...
- LightningLite:
    ...
    * Added `lightning.pytorch_lightning.lite` package ([#10175](https://github.com/Lightning-AI/lightning/pull/10175))
...
- `lightning.pytorch_lightning.utilities.grads.grad_norm` now raises an exception if parameter `norm_type <= 0` ([#9765](https://github.com/Lightning-AI/lightning/pull/9765))
...
- Deprecated `LightningModule.summarize()` in favor of `lightning.pytorch_lightning.utilities.model_summary.summarize()` ([#8513](https://github.com/Lightning-AI/lightning/pull/8513))
...
- Deprecated `LightningModule.get_progress_bar_dict` and `Trainer.progress_bar_dict` in favor of `lightning.pytorch_lightning.callbacks.progress.base.get_standard_metrics` and `ProgressBarBase.get_metrics` ([#8985](https://github.com/Lightning-AI/lightning/pull/8985))
...
- Deprecated `lightning.pytorch_lightning.core.decorators.parameter_validation` in favor of `lightning.pytorch_lightning.utilities.parameter_tying.set_shared_parameters` ([#9525](https://github.com/Lightning-AI/lightning/pull/9525))
...
- Removed deprecated `GradInformation` module in favor of `lightning.pytorch_lightning.utilities.grads` ([#8831](https://github.com/Lightning-AI/lightning/pull/8831/))
...
- Removed `lightning.pytorch_lightning.utilities.debugging.InternalDebugger` ([#9680](https://github.com/Lightning-AI/lightning/pull/9680))
...
- Removed `lightning.pytorch_lightning.trainer.connectors.OptimizerConnector` ([#10120](https://github.com/Lightning-AI/lightning/pull/10120))
...
- Added `dataclass` support for `lightning.pytorch_lightning.utilities.apply_to_collection` ([#7935](https://github.com/Lightning-AI/lightning/pull/7935))
...
- Refactored Loops
    ...
    * Removed `lightning.pytorch_lightning/trainer/training_loop.py` ([#7985](https://github.com/Lightning-AI/lightning/pull/7985))
    ...
    * Removed `lightning.pytorch_lightning/trainer/evaluation_loop.py` ([#8056](https://github.com/Lightning-AI/lightning/pull/8056))
    ...
    * Removed `lightning.pytorch_lightning/trainer/predict_loop.py` ([#8094](https://github.com/Lightning-AI/lightning/pull/8094))
...
- Deprecated `TrainerModelHooksMixin` in favor of `lightning.pytorch_lightning.utilities.signature_utils` ([#7422](https://github.com/Lightning-AI/lightning/pull/7422))
...
- Deprecated importing `rank_zero_{warn,deprecation}` directly from `lightning.pytorch_lightning.utilities.distributed` ([#8085](https://github.com/Lightning-AI/lightning/pull/8085))
...
- Pruned deprecated classif. metrics from `lightning.pytorch_lightning.metrics.functional.classification` ([#7499](https://github.com/Lightning-AI/lightning/pull/7499))
- Removed deprecated data parallel classes `LightningDataParallel` and `LightningDistributedDataParallel` from `lightning.pytorch_lightning.overrides.data_parallel` ([#7510](https://github.com/Lightning-AI/lightning/pull/7510))
...
- Fixed recursive passing of `wrong_type` keyword argument in `lightning.pytorch_lightning.utilities.apply_to_collection` ([#7433](https://github.com/Lightning-AI/lightning/pull/7433))
...
- Renamed `lightning.pytorch_lightning.callbacks.swa` to `lightning.pytorch_lightning.callbacks.stochastic_weight_avg` ([#6259](https://github.com/Lightning-AI/lightning/pull/6259))
...
- Deprecated `outputs` in both `LightningModule.on_train_epoch_end` and `Callback.on_train_epoch_end` hooks ([#7339](https://github.com/Lightning-AI/lightning/pull/7339))
- Deprecated `LightningModule.grad_norm` in favor of `lightning.pytorch_lightning.utilities.grads.grad_norm` ([#7292](https://github.com/Lightning-AI/lightning/pull/7292))
...
- Removed deprecated metrics ([#6161](https://github.com/Lightning-AI/lightning/pull/6161))
    * from `lightning.pytorch_lightning.metrics.functional.classification` removed `to_onehot`, `to_categorical`, `get_num_classes`, `roc`, `multiclass_roc`, `average_precision`, `precision_recall_curve`, `multiclass_precision_recall_curve`
    * from `lightning.pytorch_lightning.metrics.functional.reduction` removed `reduce`, `class_reduce`
...
- Removed deprecated: ([#2760](https://github.com/Lightning-AI/lightning/pull/2760))
    ...
    * package `lightning.pytorch_lightning.logging`
...
- Removed deprecated API ([#2073](https://github.com/Lightning-AI/lightning/pull/2073))
   * Packages: `lightning.pytorch_lightning.pt_overrides`, `lightning.pytorch_lightning.root_module`
   * Modules: `lightning.pytorch_lightning.logging.comet_logger`, `lightning.pytorch_lightning.logging.mlflow_logger`, `lightning.pytorch_lightning.logging.test_tube_logger`, `lightning.pytorch_lightning.overrides.override_data_parallel`, `lightning.pytorch_lightning.core.model_saving`, `lightning.pytorch_lightning.core.root_module`
...
- Added type hints to `lightning.pytorch_lightning.core` ([#946](https://github.com/Lightning-AI/lightning/pull/946))
...
- Removed duplicated module `lightning.pytorch_lightning.utilities.arg_parse` for loading CLI arguments ([#1167](https://github.com/Lightning-AI/lightning/pull/1167))
...
- Changed `lightning.pytorch_lightning.logging` to `lightning.pytorch_lightning.loggers` ([#767](https://github.com/Lightning-AI/lightning/pull/767))
...
- Deprecated `lightning.pytorch_lightning.logging` ([#767](https://github.com/Lightning-AI/lightning/pull/767))
