...
[![DockerHub](https://img.shields.io/docker/pulls/pytorchlightning/lightning.pytorch_lightning.svg)](https://hub.docker.com/r/pytorchlightning/lightning.pytorch_lightning)
...
```python
from lightning.pytorch_lightning import loggers
