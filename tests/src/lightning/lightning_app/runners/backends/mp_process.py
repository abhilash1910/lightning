...
from lightning.lightning_app.utilities.enum import WorkStageStatus
from lightning.lightning_app.utilities.network import _check_service_url_is_ready
from lightning.lightning_app.utilities.port import disable_port, enable_port
from lightning.lightning_app.utilities.proxies import ProxyWorkRun, WorkRunner
...
class MultiProcessingBackend(Backend):
    ...
    def stop_work(self, app, work: "lightning.lightning_app.LightningWork") -> None:
        work_manager: MultiProcessWorkManager = app.processes[work.name]
        work_manager.kill()

    def delete_work(self, app, work: "lightning.lightning_app.LightningWork") -> None:
