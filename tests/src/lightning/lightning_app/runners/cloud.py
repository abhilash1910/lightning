...
from lightning.lightning_app.runners.backends.cloud import CloudBackend
from lightning.lightning_app.runners.runtime import Runtime
from lightning.lightning_app.source_code import LocalSourceCodeDir
from lightning.lightning_app.source_code.copytree import _filter_ignored, _parse_lightningignore
from lightning.lightning_app.storage import Drive, Mount
from lightning.lightning_app.utilities.app_helpers import _is_headless, Logger
from lightning.lightning_app.utilities.auth import _credential_string_to_basic_auth_params
from lightning.lightning_app.utilities.cloud import _get_project
from lightning.lightning_app.utilities.dependency_caching import get_hash
from lightning.lightning_app.utilities.load_app import load_app_from_file
from lightning.lightning_app.utilities.packaging.app_config import _get_config_file, AppConfig
from lightning.lightning_app.utilities.packaging.lightning_utils import _prepare_lightning_wheels_and_requirements
from lightning.lightning_app.utilities.secrets import _names_to_ids
...
class CloudRuntime(Runtime):
    ...
    def dispatch(
        ...
        **kwargs: Any,
        ...
        """Method to dispatch and run the :class:`~lightning.lightning_app.core.app.LightningApp` in the cloud."""
    ...
    def load_app_from_file(cls, filepath: str) -> "LightningApp":
        ...
        try:
            ...
            from lightning.lightning_app.testing.helpers import EmptyFlow
