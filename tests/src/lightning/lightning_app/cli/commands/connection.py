...
from lightning.lightning_app.utilities.cli_helpers import _LightningAppOpenAPIRetriever
from lightning.lightning_app.utilities.cloud import _get_project
from lightning.lightning_app.utilities.enum import OpenAPITags
...
def connect(app_name_or_id: str):
    ...
    """
    from lightning.lightning_app.utilities.commands.base import _download_command
