...
import lightning.lightning_app.core.constants as constants
from lightning.lightning_app import __version__ as ver
from lightning.lightning_app.cli import cmd_init, cmd_install, cmd_pl_init, cmd_react_ui_init
from lightning.lightning_app.cli.cmd_apps import _AppManager
from lightning.lightning_app.cli.cmd_clusters import AWSClusterManager
from lightning.lightning_app.cli.commands.app_commands import _run_app_command
from lightning.lightning_app.cli.commands.connection import (
    _list_app_commands,
    _retrieve_connection_to_an_app,
    connect,
    disconnect,
)
from lightning.lightning_app.cli.commands.logs import logs
from lightning.lightning_app.cli.lightning_cli_create import create
from lightning.lightning_app.cli.lightning_cli_delete import delete
from lightning.lightning_app.cli.lightning_cli_list import get_list
from lightning.lightning_app.core.constants import DEBUG, ENABLE_APP_COMMENT_COMMAND_EXECUTION, get_lightning_cloud_url
from lightning.lightning_app.runners.runtime import dispatch
from lightning.lightning_app.runners.runtime_type import RuntimeType
from lightning.lightning_app.utilities.app_commands import run_app_commands
from lightning.lightning_app.utilities.app_helpers import Logger
from lightning.lightning_app.utilities.cli_helpers import (
    _arrow_time_callback,
    _check_environment_and_redirect,
    _check_version_and_upgrade,
    _format_input_env_variables,
)
from lightning.lightning_app.utilities.cluster_logs import _cluster_logs_reader
from lightning.lightning_app.utilities.exceptions import _ApiExceptionHandler, LogLinesLimitExceeded
from lightning.lightning_app.utilities.login import Auth
from lightning.lightning_app.utilities.logs_socket_api import _ClusterLogsSocketAPI
from lightning.lightning_app.utilities.network import LightningClient
from lightning.lightning_app.utilities.port import _find_lit_app_port
...
if RequirementCache("lightning-fabric>=1.9.0.dev0") or RequirementCache("lightning>=1.9.0.dev0"):
    ...
    from lightning.lightning_fabric.cli import _run_model
