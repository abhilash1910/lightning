...
if TYPE_CHECKING:
    from lightning.lightning_app.utilities.types import Component, ComponentTuple
...
class _BreadthFirstVisitor:
    ...
    def __next__(self):
        ...
        while self.queue:
            ...
            if isinstance(component, lightning.lightning_app.LightningFlow):
                ...
                for struct_name in sorted(component._structures):
                    ...
                    for _, value in values:
                        if isinstance(value, lightning.lightning_app.LightningFlow):
