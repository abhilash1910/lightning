...
from lightning.lightning_app.utilities.app_helpers import _MagicMockJsonSerializable, is_overridden
...
def _collect_layout(app: "lightning.lightning_app.LightningApp", flow: "lightning.lightning_app.LightningFlow") -> Union[Dict, List[Dict]]:
...
def _collect_content_layout(
    layout: List[Dict], app: "lightning.lightning_app.LightningApp", flow: "lightning.lightning_app.LightningFlow"
    ...
    for entry in layout:
        ...
        elif isinstance(entry["content"], lightning.lightning_app.LightningFlow):
            entry["content"] = entry["content"].name

        elif isinstance(entry["content"], lightning.lightning_app.LightningWork):
            work = entry["content"]
...
def _collect_work_layout(work: "lightning.lightning_app.LightningWork") -> Union[None, str, Frontend, _MagicMockJsonSerializable]:
