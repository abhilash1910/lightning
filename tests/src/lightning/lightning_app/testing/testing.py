...
from lightning.lightning_app import LightningApp, LightningFlow
from lightning.lightning_app.cli.lightning_cli import run_app
from lightning.lightning_app.core.constants import LIGHTNING_CLOUD_PROJECT_ID
from lightning.lightning_app.runners.multiprocess import MultiProcessRuntime
from lightning.lightning_app.testing.config import _Config
from lightning.lightning_app.utilities.app_logs import _app_logs_reader
from lightning.lightning_app.utilities.cloud import _get_project
from lightning.lightning_app.utilities.enum import CacheCallsKeys
from lightning.lightning_app.utilities.imports import _is_playwright_available, requires
from lightning.lightning_app.utilities.log import get_logfile
from lightning.lightning_app.utilities.logs_socket_api import _LightningLogsSocketAPI
from lightning.lightning_app.utilities.network import _configure_session, LightningClient
from lightning.lightning_app.utilities.packaging.lightning_utils import get_dist_path_if_editable_install
from lightning.lightning_app.utilities.proxies import ProxyWorkRun
...
def application_testing(
    ...
    patch1 = mock.patch("lightning.lightning_app.LightningApp", lightning_app_cls)
...
def run_app_in_cloud(
    ...
    # 6. Create chromium browser, auth to lightning.lightning_app.ai and yield the admin and view pages.
