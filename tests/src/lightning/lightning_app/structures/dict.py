...
from lightning.lightning_app.utilities.app_helpers import _LightningAppRef, _set_child_name
...
class Dict(t.Dict[str, T]):
    def __init__(self, **kwargs: T):
        ...
        or :class:`~lightning.lightning_app.core.flow.LightningFlow`.

        Example:

            >>> from lightning.lightning_app import LightningFlow, LightningWork
            >>> from lightning.lightning_app.structures import Dict
