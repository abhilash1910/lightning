...
from lightning.lightning_app import structures
...
from lightning.lightning_app.storage.path import Path
from lightning.lightning_app.utilities.app_helpers import Logger
from lightning.lightning_app.utilities.packaging.cloud_compute import CloudCompute
...
class PyTorchLightningScriptRunner(TracerPythonScript):
    ...
    def on_after_run(self, script_globals):
        from lightning.pytorch_lightning import Trainer
        from lightning.pytorch_lightning.cli import LightningCLI
    ...
    def _trainer_init_pre_middleware(self, trainer, *args, **kwargs):
        ...
        from lightning.pytorch_lightning.serve import ServableModuleValidator
    ...
    def __init__(
        ...
        **script_runner_kwargs,
        ...
        Example::
            ...
            from lightning.lightning_app import LightningApp
            from lightning.lightning_app.components.training import LightningTrainerScript
            from lightning.lightning_app.utilities.packaging.cloud_compute import CloudCompute
