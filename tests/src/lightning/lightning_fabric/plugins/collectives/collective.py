...
from lightning.lightning_fabric.utilities.types import CollectibleGroup
...
class Collective(ABC):
    ...
    def create_group(self, **kwargs: Any) -> Self:  # type: ignore[valid-type]
        ...
        This assumes that :meth:`~lightning.lightning_fabric.plugins.collectives.Collective.init_group` has been
