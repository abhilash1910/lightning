...
from lightning.lightning_fabric.utilities.device_parser import _check_data_type
...
def _parse_tpu_devices(devices: Optional[Union[int, str, List[int]]]) -> Optional[Union[int, List[int]]]:
    ...
    :class:`~lightning.pytorch_lightning.trainer.Trainer` and :class:`~lightning.lightning_fabric.Fabric`.
