...
from lightning_fabric.utilities.device_parser import _determine_root_gpu_device, _determine_root_xpu_device
...
from pytorch_lightning.accelerators.xpu import XPUAccelerator
...
from pytorch_lightning.plugins import XPUPrecisionPlugin,XPUBf16PrecisionPlugin
...
from pytorch_lightning.tuner.auto_xpu_select import pick_multiple_xpus
    ...
    def _set_devices_flag_if_auto_select_xpus_passed(self) -> None:
        if self._auto_select_xpus is not None:
            rank_zero_deprecation(
                ...
                " Please use the function `pytorch_lightning.accelerators.find_usable_xpu_devices` instead."
            )
