...
@pytest.fixture(scope="function")
def xpu_available(xla_available, monkeypatch) -> None:
    monkeypatch.setattr(pytorch_lightning.accelerators.xpu.XPUAccelerator, "is_available", lambda: True)
    monkeypatch.setattr(lightning_fabric.accelerators.xpu.XPUAccelerator, "is_available", lambda: True)
